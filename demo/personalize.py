...
from utils import cam_calibrate
from person_calibration import collect_data, fine_tune
from frame_process import frame_processer

#################################
# Start camera
#################################
# adjust these for your camera to get the best accuracy
call("v4l2-ctl -d /dev/video0 -c brightness=100", shell=True)
...
gaze_network = fine_tune(subject, data, frame_processor, mon, device, gaze_network, k)
